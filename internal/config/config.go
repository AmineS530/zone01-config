...
// LoadConfig attempts to read a saved configuration from ~/.config/zone01-config/config.json.
...
// SaveConfig writes the given UserConfig to ~/.config/zone01-config/config.json.
