...
<body>
    ...
    <div class="container">
        ...
        <div class="glass-card" id="wizardCard">
            ...
            <div class="step-content" id="step5">
                ...
                <div class="toggle-card">
                    <div class="toggle-info">
                        <div class="toggle-title">Install Discord Portable</div>
                        <div class="toggle-desc">Downloads, extracts, and configures a secondary, sandboxed instance of Discord.</div>
                    </div>
                    <label class="switch">
                        <input type="checkbox" id="installDiscord">
                        <span class="slider"></span>
                    </label>
                </div>
                <div class="toggle-card">
            ...
            <div class="step-content" id="step6">
                ...
                <div class="summary-list">
                    ...
                    <div class="summary-row">
                        <span class="summary-label">Install Discord Portable</span>
                        <span class="summary-value" id="sumDiscord"><span class="indicator"></span><span></span></span>
                    </div>
                    <div class="summary-row">
                ...
                <div class="toggle-card" style="margin-top: 24px;">
                    <div class="toggle-info" style="text-align: left;">
                        ...
                        <div class="toggle-desc">Automatically save these choices to ~/.config/zone01-config/config.json.</div>
                    </div>
                    <label class="switch">
    ...
    <script>
        ...
        function applyConfigToUI(cfg) {
            ...
            document.getElementById("installDiscord").checked = cfg.enable_discord === true;
        ...
        function renderSummary() {
            ...
            updateSummaryRow("sumDiscord", document.getElementById("installDiscord").checked, "Install Discord Portable", "Skip Discord");
        ...
        async function submitConfig() {
            ...
            const enableDiscord = document.getElementById("installDiscord").checked;
